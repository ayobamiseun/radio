...
<html lang="en">
<head>
<title>Podcasts | Super 96.3 FM</title>
<meta charset="utf-8">
...
";
    $title = 'SuperFM 96.3';
     ...
     $url = "http://superfm963.com/podcasts";
				...
				<div class="col-lg-9 episodes_col">
					<div class="episodes_container">
						...
						<?php 
							...
							$sqlm = mysqli_query($con,"select * from podcasts where delStatus != 'deleted' order by id desc limit 10");
							while ($rowm = mysqli_fetch_array($sqlm)) {
								...
								echo '<div class="episode d-flex flex-row align-items-start justify-content-start s1">
									...
									<div class="episode_content">
										<div class="episode_name"><a href="podcast?id='.$m_uid.'">'.$m_title.'</a></div>
										<div class="episode_date"><a href="podcast?id='.$m_uid.'">'.$m_date.'</a></div>
