<?php 
							...
							$sqlm = mysqli_query($con,"select * from posts where title_uid = '$title_uid'");
							...
							$upd = mysqli_query($con,"update news set posts = '$vv' where uid = '$uid'");
...
<?php include('meta.php'); ?>
   ...
   <?php 
    ...
    $title = $m_title+' | Super 96.3 FM';
     ...
     $url = "http://superfm963.com/news-post?id=".$title_uid;
					...
					<div class="intro">
						...
						<div style="margin-top: 10px;">
	                         ...
	                         <h6 style="color: #999;">share this post</h6>
	                            ...
	                            <span class="btn btn-primary btn-sm" data-sharer="twitter" data-title="<?php echo $m_title; ?>" data-hashtags="Super96.3FM" data-url="http://superfm963.com/news-post?id=<?php echo $title_uid; ?>"><i class="fa fa-twitter"></i> </span>

	                            <span class="btn btn-success btn-sm" data-sharer="whatsapp" data-title="<?php echo $m_title; ?>" data-hashtags="Super96.3FM" data-url="http://superfm963.com/news-post?id=<?php echo $title_uid; ?>"><i class="fa fa-whatsapp"></i> </span>

	                            <span class="btn btn-primary btn-sm" data-sharer="facebook" data-title="<?php echo $m_title; ?>" data-hashtags="Super96.3FM" data-url="http://superfm963.com/news-post?id=<?php echo $title_uid; ?>"><i class="fa fa-facebook"></i> </span>

	                            <span class="btn btn-danger btn-sm" data-sharer="googleplus" data-title="<?php echo $m_title; ?>" data-hashtags="Super96.3FM" data-url="http://superfm963.com/news-post?id=<?php echo $title_uid; ?>"><i class="fa fa-google-plus"></i> </span>

	                            <span class="btn btn-secondary btn-sm" data-sharer="email" data-title="<?php echo $m_title; ?>" data-hashtags="Super96.3FM" data-url="http://superfm963.com/news-post?id=<?php echo $title_uid; ?>"><i class="fa fa-envelope"></i> </span>

	                            <span class="btn btn-primary btn-sm" data-sharer="telegram" data-title="<?php echo $m_title; ?>" data-hashtags="Super96.3FM" data-url="http://superfm963.com/news-post?id=<?php echo $title_uid; ?>"><i class="fa fa-telegram"></i> </span>

	                            <span class="btn btn-primary btn-sm" data-sharer="linkedin" data-title="<?php echo $m_title; ?>" data-hashtags="Super96.3FM" data-url="http://superfm963.com/news-post?id=<?php echo $title_uid; ?>"><i class="fa fa-linkedin"></i> </span>
	...
	$('.post').click(function(){
      ...
      function PostFireComment(name,email,message,time,country,uid){
	      ...
	      store.set("blog_email",email);
	        ...
	        db.collection("BlogComments").doc("blogcomments").collection(uid).add({
       ...
       function GetComment(){
        ...
        function GetTopPost(){
            ...
            $.getJSON('j_news.php',{uid2:uid, limit:5}, function(data) {
              $('.Toplist').html('');
             //alert(data.Feed.length);
              $.each(data.Feed,  function(i,result){

                var newRow = '<div class="block-21 mb-4 d-flex">'
                  +'<a href="news-post?id='+result.title_uid+'" class="blog-img mr-4" style="background-image: url('+result.thumb+');"></a>'
                  +'<div class="text">'
                   +'<h3 class="heading"><a href="news-post?id='+result.title_uid+'">'+result.title+'s</a></h3>'
                    +'<div class="meta">'
