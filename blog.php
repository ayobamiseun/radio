...
<html lang="en">
<head>
<title>Blog | Super 96.3 FM </title>
<meta charset="utf-8">
...
<?php 
      ...
      $title = 'Blog | Super 96.3 FM';
      $url = "http://superfm963.com/blog";
   ?>
				...
				<div class="col-lg-9 blog_col order-lg-2w order-1w">
					<div class="blog_posts">
						...
						<?php 
							...
							$sqln = mysqli_query($con,"select * from news order by odr asc, id desc limit $pag,10");
				            while ($rown = mysqli_fetch_array($sqln)) {
				              ...
				              echo '<div class="blog_post d-flex flex-md-row flex-column align-items-start justify-content-start">
									<div class="blog_post_image">
										...
										<div class="blog_post_date"><a href="blog-post?id='.$blg_title_uid.'">'.$blg_date.'</a></div>
									</div>
									<div class="blog_post_content">
										<div class="blog_post_title"><a href="blog-post?id='.$blg_title_uid.'">'.$blg_title.'</a></div>
										<div class="blog_post_author">By <a href="#">Admin</a></div>
										<div class="blog_post_text" style="margin:0px; padding:0px;">
											<p>'.$descp.'</p>
										</div>
										<div class="blog_post_link"><a href="blog-post?id='.$blg_title_uid.'">Read More</a></div>
									</div>
								</div>';
						...
						<div class="col">
							<div class="page_nav d-flex flex-row align-items-center justify-content-center">
								<ul class="d-flex flex-row">
									...
									<?php
										$sqlv = mysqli_query($con,"select id from news");
